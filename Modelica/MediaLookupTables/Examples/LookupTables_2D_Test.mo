...
model LookupTables_2D_Test
  LookupTables_2D lookupTables_2D(tablePath_y=
        Modelica.Utilities.Files.loadResource(
        "modelica://MediaLookupTables/Resources/data/lookupTables/ParaHydrogen/pT/d.csv"))
...
equation
  connect(const.y, lookupTables_2D.u2) annotation (Line(points={{-39,-20},{-26,
